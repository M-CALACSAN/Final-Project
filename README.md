...
1. How does each school type rank in starting median salaries? (Highest starting salary to lowest)
...
_**Question 1: How does each school type tank in starting median salaries? (highest - lowest)**_
